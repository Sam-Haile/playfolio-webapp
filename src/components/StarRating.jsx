...
const FullStar = ({ color }) => (
  <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={color} className="w-full h-full">
...
const HalfStar = ({ activeColor, neutralColor }) => (
  <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-full h-full">
    <defs>
