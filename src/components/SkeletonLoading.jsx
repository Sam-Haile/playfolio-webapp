            ...
            <div className="mx-[15%] grid grid-cols-[65%_35%]">
              <div className="h-[auto]">
                ...
                <div className="grid grid-cols-3 gap-8">
                  <div className="w-[80%]">
                    <div className="w-[40%] h-[20px] bg-gray-300 animate-pulse mb-2 rounded"></div>
                    <div className="w-full h-[20px] bg-gray-200 animate-pulse rounded"></div>
                  </div>

                  <div>
                    <div className="w-[50%] h-[20px] bg-gray-300 animate-pulse mb-2 rounded"></div>
                    <div className="w-full h-[20px] bg-gray-200 animate-pulse rounded"></div>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-8">
                  ...
                  <div className="relative">
                    <div className="w-[15%] h-full absolute right-0 bottom-0 bg-gray-300 animate-pulse rounded"></div>
                  </div>
                </div>
              ...
              {/* Skeleton Sidebar */}
              <div>
                <div className="bg-gray-300 rounded h-[200px] w-[90%] ml-12 animate-pulse mt-8"></div>
                <div className="bg-gray-300 rounded h-[300px] w-[90%] ml-12 mt-14 animate-pulse"></div>
                <div className="mt-16 pl-12 mb-12">
                  <div className="w-[30%] h-[20px] bg-gray-300 animate-pulse mb-4 rounded"></div>
                  <div className="w-full h-[100px] bg-gray-200 animate-pulse rounded"></div>
                </div>
                <div className="mt-16 pl-12 mb-12">
            ...
            <div className="grid grid-cols-8 gap-2">
              {Array(8)
                ...
                .map((_, index) => (
                  <div
                    key={index}
                    className="w-full h-[580px] bg-gray-700 animate-pulse rounded"
                  ></div>
                ))}
            </div>
